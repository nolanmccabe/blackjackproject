...
int main()
{
	...
	int playerHandTotal = 0; //Sum of hand
	int computerHandTotal = 0;
	int playerEndGameResult, computerEndGameResult; //Determines end game results
...
/*---------------------------------------------Dealing Cards ----------------------------------------------------*/
		...
		Sleep(2500);
/*---------------------------------------------Player's Turn -----------------------------------------------------*/
		while (playerTurn) //Loops until player has over 21 or holds/folds
		{
		...
		Sleep(2500);
/*---------------------------------------------Computer's Turn ---------------------------------------------------*/
		while (computerTurn) //Loops until computer wins or loses
		{
...
/*-----------------------------------------------End Game --------------------------------------------------------*/
		if (playerEndGameResult == playerHold && computerEndGameResult == computerBust)
		{
			...
			std::cout << "Player Hand Total: " << playerHandTotal << std::endl;
			std::cout << "Computer Hand Total:" << computerHandTotal << std::endl;
		}
